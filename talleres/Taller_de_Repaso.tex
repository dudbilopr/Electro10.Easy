...
\usepackage{lmodern} % Fuente estándar moderna
\usepackage{graphicx}
\usepackage{tikz}
...
% Configuración de márgenes estilo libro (asimétricos)
\geometry{
  a4paper,
  top=2.5cm,
  bottom=2.5cm,
...
% Encabezados y pies de página (Book style)
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE,RO]{\thepage}
\fancyhead[RE]{\textcolor{unabBlue}{\textit{Curso de Electromagnetismo}}}
\fancyhead[LO]{\textcolor{unabBlue}{\textit{Taller de Repaso: Electrostática}}}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\footrulewidth}{0pt}

% Comando de sección manual optimizado en espacio
\newcommand{\mysection}[1]{
  \vspace{0.3cm}\noindent{\Large\bfseries\color{unabBlue} #1}
  \vspace{0.1cm}\hrule\vspace{0.2cm}
}
\newcommand{\mysubsection}[1]{
  \vspace{0.2cm}\noindent{\large\bfseries\color{unabOrange} #1}
  \vspace{0.1cm}
}

% Entornos personalizados eliminados por compatibilidad
\newcommand{\raebox}[1]{
  \vspace{0.4cm}
...
% Portada o Título Elegante
\thispagestyle{empty}
\begin{center}
    \vspace*{2cm}
    \rule{\textwidth}{1pt}\vspace{0.5cm}
    {\Huge\textbf{\textcolor{unabBlue}{Electrostática y Campo Eléctrico}}}\\
    \vspace{0.5cm}
    {\Large\textit{Taller de Repaso y Modelado Matemático}}\\
    \vspace{0.5cm}\rule{\textwidth}{1pt}
    \vspace{1cm}
    {\large \textbf{Autor:} Dudbil Olvasada Pabon Riaño}\\
    {\large \textbf{Institución:} Universidad Autónoma de Bucaramanga (UNAB)}\\
    \vspace{2cm}
\end{center}

\noindent\textbf{Prefacio:} Este compendio presenta una colección estructurada de preguntas conceptuales y problemas analíticos seleccionados del texto \textit{Problemas de Física Tomo II} (Burbano). El diseño tipográfico sigue los estándares de los textos universitarios en ciencias exactas. Los problemas están categorizados por dificultad para guiar el estudio autónomo. 
