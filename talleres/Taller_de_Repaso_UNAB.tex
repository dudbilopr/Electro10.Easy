...
\fancyhead[R]{%
  \begin{minipage}{0.4\textwidth}
    \raggedleft
    \includegraphics[width=4.4cm]{../../Plantilla_LaTeX_Examen_Ciencia_de_Datos_UNAB/logo_ciencia_datos_negro.png}\\[2pt]
    {\scriptsize \textcolor{gray}{\textbf{Departamento de Ciencias Básicas}}}
  \end{minipage}}
\renewcommand{\headrulewidth}{0pt}
\fancyfoot[C]{\scriptsize \textcolor{gray}{Universidad Autónoma de Bucaramanga -- UNAB \hspace{0.7em}|\hspace{0.7em} Departamento de Ciencias Básicas}}
